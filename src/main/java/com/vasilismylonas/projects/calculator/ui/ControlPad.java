...
public class ControlPad extends JPanel {
    ...
    private final CallbackActionListener ceListener = new CallbackActionListener();
    private final CallbackActionListener modeListener = new CallbackActionListener();
    ...
    public void onClear(ActionListener listener) { clearListener.setListener(listener); }

    public void onClearEntry(ActionListener listener) { ceListener.setListener(listener); }

    public void onMode(ActionListener listener) { modeListener.setListener(listener); }

    private void addButton(ControlButton button, ActionListener actionListener, GridBagConstraints gbc) {
        add(button, gbc);
